    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                {relatedGames.map((game, index) => (
                  <div
                    key={game.title}
                    className="group bg-gray-50 rounded-2xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 overflow-hidden"
                  ...
                  >
                    <div className="p-4 sm:p-6">
                      ...
                      <a
                        href={game.href}
                        className="flex items-center text-blue-600 group-hover:text-blue-700 font-medium text-xs sm:text-sm"
                      >
                        Get Hints
          ...
          {/* All Solvers CTA Button */}
          <div className="text-center">
            <a
              href="/all-solvers"
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-block"
            >
              View All Solvers
            </a>
          </div>
