        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-4 gap-3 max-w-2xl mx-auto">
            {puzzleData.categories.flatMap(cat => cat.words).sort().map((word, index) => (
              <div
                key={word}
                className="bg-gray-100 rounded-lg p-4 text-center font-semibold text-gray-800 hover:bg-gray-200 transition-colors duration-200"
              >
                {word}
              </div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-600">
                <li>• Start with the most obvious connections</li>
                <li>• Look for common themes or categories</li>
                <li>• Yellow is usually the easiest category</li>
                <li>• Purple often has wordplay or tricks</li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-800 mb-2">Common Categories</h4>
              <ul className="space-y-1 text-sm text-gray-600">
                <li>• Things that go together</li>
                <li>• Words with multiple meanings</li>
                <li>• Prefixes or suffixes</li>
