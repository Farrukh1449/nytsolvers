...
import { Search, Users, RefreshCw, Settings, Star, Filter } from 'lucide-react';

const WordsWithFriendsSolver: React.FC = () => {
  ...
  const sampleResults = [
    { word: 'QUARTZ', points: 28, definition: 'A hard mineral' },
    { word: 'ZEPHYR', points: 26, definition: 'A gentle breeze' },
    { word: 'JAZZY', points: 36, definition: 'Having the characteristics of jazz' },
    { word: 'FIZZY', points: 32, definition: 'Containing bubbles of gas' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 pt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-4">
            <Users className="w-4 h-4 mr-2" />
            Words With Friends Solver
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Words With Friends <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Solver</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Find the highest scoring Words With Friends words from your letters with advanced filtering options
          </p>
        </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white py-3 px-6 rounded-xl font-semibold hover:from-blue-600 hover:to-cyan-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center disabled:opacity-50"
              >
                {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="flex justify-between"><span>A,E,I,L,N,O,R,S,T</span><span>1</span></div>
                <div className="flex justify-between"><span>D,G</span><span>2</span></div>
                <div className="flex justify-between"><span>B,C,M,P</span><span>4</span></div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-3">
                {results.map((result, index) => (
                  <div
                    key={result.word}
                    className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg hover:from-blue-100 hover:to-cyan-100 transition-all duration-200"
                    style={{
...
export default WordsWithFriendsSolver;